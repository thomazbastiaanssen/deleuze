...
For code on bayesian bootstrapped two-sample consistency click [Here](https://github.com/thomazbastiaanssen/deleuze/blob/main/docs/bootstrapping_distance.md)
