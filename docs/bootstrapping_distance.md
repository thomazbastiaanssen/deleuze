...
data.frame(as.matrix(dist_l[[1]])) %>% 
  ...
  geom_tile() +
  geom_text(colour = "black", size = 2.5) +
  scale_fill_gradient2(low = "blue", high = "red", mid = "white", midpoint = 0, limits = c(-5,5), "Estimated distance") +
  theme_bw() +
  ggtitle("Error from true distance: 10", subtitle = "10% Rare features") +
  xlab("Sampling depth of first sample x 1K") +
  ylab("Sampling depth of second sample x 1K")
```
...
data.frame(as.matrix(dist_l[[2]])) %>% 
  ...
  scale_fill_gradient2(low = "blue", high = "red", mid = "white", midpoint = 0, limits = c(-5,5), "Estimated distance") +
  theme_bw() +
  ggtitle("Error from true distance: 20", subtitle = "10% Rare features") +
  xlab("Sampling depth of first sample x 1K") +
  ylab("Sampling depth of second sample x 1K")
```
...
data.frame(as.matrix(dist_l[[3]])) %>% 
  ...
  scale_fill_gradient2(low = "blue", high = "red", mid = "white", midpoint = 0, limits = c(-5,5), "Estimated distance") +
  theme_bw() +
  ggtitle("Error from true distance: 30", subtitle = "10% Rare features") +
  xlab("Sampling depth of first sample x 1K") +
  ylab("Sampling depth of second sample x 1K")
```
...
data.frame(as.matrix(dist_l[[4]])) %>% 
  ...
  scale_fill_gradient2(low = "blue", high = "red", mid = "white", midpoint = 0, limits = c(-5,5), "Estimated distance") +
  theme_bw() +
  ggtitle("Error from true distance: 40", subtitle = "10% Rare features") +
  xlab("Sampling depth of first sample x 1K") +
  ylab("Sampling depth of second sample x 1K")
```
...
data.frame(as.matrix(dist_l[[5]])) %>% 
  ...
  scale_fill_gradient2(low = "blue", high = "red", mid = "white", midpoint = 0, limits = c(-5,5), "Estimated distance") +
  theme_bw() +
  ggtitle("Error from true distance: 50", subtitle = "10% Rare features") +
  xlab("Sampling depth of first sample x 1K") +
  ylab("Sampling depth of second sample x 1K")
```
